...
class EditionsControllerTest < ActionController::TestCase
  ...
  test "should create edition" do
    assert_difference('Edition.count') do
      post :create, edition: { e_date: @edition.e_date, e_name: @edition.e_name, journal_id: @edition.journal_id }
    end
  ...
  test "should update edition" do
    patch :update, id: @edition, edition: { e_date: @edition.e_date, e_name: @edition.e_name, journal_id: @edition.journal_id }
    assert_redirected_to edition_path(assigns(:edition))
  end
